...
export default function HomeSlider() {
  ...
  return (
    <div className="relative w-full h-90 md:h-100 lg:h-170 overflow-hidden bg-transparent">
      {/* 📱 MOBILE / TABLET */}
      <div className="flex flex-col gap-4 lg:hidden mt-5">
        ...
        <div
          className="
            ...
            bg-linear-to-r from-(--background-bg) to-transparent
          "
        />
        ...
        <div
          className="
            ...
            bg-linear-to-l from-(--background-bg) to-transparent
          "
        />
      ...
      <div className="hidden lg:grid grid-cols-2 gap-6 h-full">
        ...
        <div
          className="
            ...
            bg-linear-to-b from-(--background-bg) to-transparent
          "
        />
        ...
        <div
          className="
            ...
            bg-linear-to-t from-(--background-bg) to-transparent
          "
        />
